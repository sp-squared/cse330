...
void random_vector(int k, int from, int upto, List<int>& v, int negs)
{
	rand_seed();
	v.clear();
...
void random_vector_norep(int k, int from, int upto, List<int>& v, int negs)
{
	int next;
	rand_seed();
	v.clear();
	List<int> in(upto + 1, 0);
